...
| 항목 | 값 |
| --- | --- |
| 범위 | 영어·일본어·독일어·프랑스어·스페인어·중국어 단어 480개, 문장 240개 |
...
2026.08 카탈로그에는 체크인·교통·결제·응급 상황·업무·언어 학습에 쓰는
실용 문장을 언어별 20개씩 추가했다. 모든 추가 문장은 프로젝트에서 직접
작성했으며 일본어 읽기·로마자, 중국어 병음, 문장 배열용 수동 토큰을 함께
검수한다.
