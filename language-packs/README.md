...
현재는 영어·일본어·독일어·프랑스어·스페인어·중국어용 TUFS 생활 핵심
어휘 전체본을 각각 하나씩 제공한다. 한국어와 각 학습 언어를 짝별로
맞춘 자료라 언어별로 449~469개다. 영어에는 별도로 TOSS 기본 어휘·숙어
5,000개와 TOEIC 기본 어휘·숙어 5,000개를 제공한다. 두 시험 팩은 공식 시험
문제나 유료 교재를 복제한 것이 아니라 공개 어휘 목록과 Sprache가 직접
정리한 회화·업무 표현을 바탕으로 만든다.
같은 표제어의 여러 한국어 뜻은 한
항목의 정답으로 보존하고, 앱 기본 자료와 겹치는 항목도 가져오기 단계에서
중복 없이 합쳐진다. 앱에 이미 포함된 생활 문장
100개는 그대로 유지된다.
